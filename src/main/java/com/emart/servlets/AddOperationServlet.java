...
import com.emart.dao.CategoryDao;
import com.emart.dao.ProductDao;
import com.emart.entities.Category;
import com.emart.entities.Message;
...
public class AddOperationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (operation.trim().equals("addCategory")) {
			...
			String path = request.getServletContext().getRealPath("/src/main/webapp/") + "Product_imgs" + File.separator
